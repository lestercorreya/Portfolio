...
const AboutSection = () => {
  return (
    <div className='w-screen p-5 min-h-regularScreen flex flex-col justify-center lg:px-48 md:p-6'>
      <div className='text-base text-primary mb-4 font-semibold md:text-lg md:mb-6'>About me</div>
      ...
      <div className='md:flex'>
        <div className='font-primary text-xl mb-5 mr-5 text-primary font-extrabold md:flex-1 md:text-3xl lg:text-4xl'>I design professional & beautiful websites</div>
        <div className='text-base text-secondary md:flex-1 md:text-lg'>
          <div className='mb-4'>
