...
const FixedBackground = (props) => {
  ...
  return (
    <div>
      ...
      <div className='fixed bottom-10 right-10 z-20 rounded-full p-2 bg-primary shadow-lg shadow-secondary hover:p-3 hover:right-9 hover:bottom-9 cursor-pointer transition-opacity' style={{ opacity: homeInView ? "0" : "1", pointerEvents: homeInView ? "none" : "all" }}>
