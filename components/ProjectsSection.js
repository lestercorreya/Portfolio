...
const ProjectsSection = (props) => {
  ...
  const projects = [
    {
      "title": "Chess Burst",
      "description": "An online chess game that can be played between 2 people using a common 5-digit code generated by one of them.",
      "image": projectImage1,
      "video": "project_1.mp4"
    },
    {
      "title": "Listenal",
      "description": "A Spotify-integrated real-time chat application that lets you chat and listen to songs simultaneously with another person.",
      "image": projectImage2,
      "video": "project_2.mp4"
    },
    {
      "title": "Python Mini Projects",
      "description": "Few of the mini-projects built using python by integrating certain data structures and algorithms.",
      "image": projectImage3,
      "video": "project_3.mp4"
    },
  ]
  ...
  return (
    <div className='min-h-regularScreen px-5 py-10 md:px-10 lg:px-48 bg-background' ref={(node) => setRefs(node, "projects")}>
      ...
      <div className='text-secondary text-lg mb-20 md:text-xl md:w-4/5 md:ml-20 lg:text-2xl lg:mb-36 border-l-2 border-primary pl-6'>
        <div className='transition-all duration-500' style={{ transform: onceInView ? "translateY(0)" : "translateY(50px)", opacity: onceInView ? "1" : "0" }}>A Collection of favorites projects I have built. Feeling great while sharing them here</div>
      </div>
        ...
        return (
          <div className='md:flex mb-16 transition-opacity duration-500 delay-500 md:mb-10' style={{ opacity: onceInView ? "1" : "0", flexDirection: index % 2 === 0 ? "row-reverse" : "row" }} key={project.title}>
            ...
            <div className='flex-1 flex justify-center flex-col'>
              <div className='text-3xl font-extrabold mb-2 font-primary md:mx-5'>{project.title}</div>
              <div className='w-12 h-0.5 bg-primary mb-5 md:mx-5'></div>
              <div className='text-secondary mb-5 lg:text-xl md:mx-5'>{project.description}</div>
            </div>
          </div>
        )
      })}
